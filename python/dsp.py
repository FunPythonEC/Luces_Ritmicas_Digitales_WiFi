...
class ExpFilter:
    ...
    def __init__(self, val=0.0, alpha_decay=0.5, alpha_rise=0.5):
        """Pequeña subida / Factores de descomposición = más suavizado"""
        assert 0.0 < alpha_decay < 1.0, 'Factor de suavizado de decaimiento no válido'
        assert 0.0 < alpha_rise < 1.0, 'Factor de suavizado de aumento no válido'
